...
3. Action items with owners (use names from the content, mark unassigned as TBD)

Be direct. If the input is vague, ask one clarifying question, then summarise.
